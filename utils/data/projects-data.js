export const projectsData = [
  ...
  },
  {
    ...
    description:
      "Cette application est une solution complète de gestion d'une boutique en ligne, développée avec Spring Boot pour le backend et Angular pour le frontend. Elle permet aux administrateurs de gérer les produits, les commandes, les clients et les paiements, tout en offrant aux utilisateurs une expérience fluide d'achat en ligne.",
    tools: [
      "Spring Boot",
      "Spring MVC ",
      "Angular",
